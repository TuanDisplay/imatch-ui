...
export default function UploadImageField({
  ...
  const [isCheckRadio, setIsCheckRadio] = useState<boolean>(false);
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      {radioRegis && (
        <YesNoRadio register={radioRegis} setIsCheckRadio={setIsCheckRadio} />
      )}
      {(name === 'relatedImgUpload' || isCheckRadio) && (
