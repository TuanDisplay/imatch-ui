...
export default function Solution({ problem_id }: { problem_id: string }) {
  ...
  const { data: payProData, isLoading: payProLoading } =
    usePayProblem(problem_id);
  ...
  const handleBuySol = (solution_id: string) => {
    setSolutionId(solution_id);
    setIsPayProductModal(true);
  };
  return (
    <>
      {isPayProductOpen && (
                        ...
                        >
                          ...
                          <div className="flex justify-between">
                            ...
                            <Button
                              ...
                              accept
                              onClick={() => handleBuySol(item.uuid)}
                            >
                              Duyệt giải pháp
                            </Button>
                          </div>
